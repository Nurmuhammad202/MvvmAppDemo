...
import uz.personal.mvvmappdemo.foundation.utils.finiteShareIn
import uz.personal.mvvmappdemo.foundation.views.BaseViewModel
import uz.personal.mvvmappdemo.foundation.views.ResultFlow
import uz.personal.mvvmappdemo.foundation.views.ResultMutableStateFlow
...
import uz.personal.mvvmappdemo.simplemvvm.views.changecolor.ChangeColorFragment.Screen
import uz.personal.mvvmappdemo.R
import uz.personal.mvvmappdemo.foundation.model.*
...
class ChangeColorViewModel(
    ...
    // input sources
    private val _availableColors: ResultMutableStateFlow<List<NamedColor>> = MutableStateFlow(
        PendingResult()
    )
    ...
    private fun mergeSources(colors: Result<List<NamedColor>>, currentColorId: Long,
                             instantSaveInProgress: Progress, sampledSaveInProgress: Progress
    ): Result<ViewState> {
