package uz.personal.mvvmappdemo.foundation

import android.content.Context
import androidx.annotation.MainThread
import uz.personal.mvvmappdemo.foundation.views.ViewModelFactory
...
object SingletonScopeDependencies {
    ...
    fun init(factory: SingletonsFactory) {
        if (SingletonScopeDependencies.factory != null) return
        SingletonScopeDependencies.factory = factory
    }
